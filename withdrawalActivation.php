...
$insuranceKey = "e6OjuvDFx-oRg";

 if(isset($_POST['nextInsurance'])){
   
        $insurancePin = $_POST['insurancePin'];
        // $insuranceCode = $_POST['insuranceId'];
        //  $_SESSION['InsuaranceId'] = $insuranceCode; 
       
       
 if($insurancePin !== $insuranceKey){
    $_SESSION['status']="Insurance not Received- Review Key sent by Admin";
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                    <div class="notice">
                                        <h3>*Pay $87 to Unlock all time withdrawals<label>*This pop-up will never show once fee is cleared</label></h3>
                                    ...
                                    <div class="form-group">
                                        <label for="AccountNo">Withdrawal Key:</label>
                                            <input type="password" class="form-control" id="transaction" placeholder="Enter Insurance key" name="withdrawalPin" required>
                                    </div> 
