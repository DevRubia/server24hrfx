...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $amount=$_POST['depoAmt']; 
    $transactionId=$_POST['transactionId'];
    $Account=$_POST['paymentMeans'];
    $name=$_POST['name'];
...
//Create instance of PHPMailer
    ...
    //Finally send email
        ...
        header('Location: https://24hrfxtradingorg.co.ke/newDashboard.php?status=error');
        exit();;
        }
    }catch(Exception $e){
        $_SESSION['status']="failed!!!";
    ...
    //Closing smtp connection
        ...
        header('Location: https://24hrfxtradingorg.co.ke/depositPopup.php?status=success');
        exit();
    }else{
    ...
    header('Location: https://24hrfxtradingorg.co.ke/deposit.php?status=error');
}
