                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                    <div class="notice">
                                        <h3>*Pay $137 to cover your tradings account insuarance cover Fee<label>#This pop-up will never show once fee is cleared, you will be fowarded directly to the withdrawalPage</label></h3>
                                    ...
                                    <!--        <input type="text" class="form-control" id="transaction" placeholder="#payment transaction code" name="insuranceId" required>-->
                                    <!--</div>-->

                                    <div class="form-group">
                                        <label for="AccountNo">Insurance Key:</label>
                                            <input type="password" class="form-control" id="transaction" placeholder="Enter Insurance key" name="insurancePin" required>
                                    </div>        
