				...
				<div class="col-md-12">
					...
					<div class="card hold">
						<div class="card-header hold bg-dark">
							<h2 class="text-white">
								My Deposit Transactions.
                                
								<a href="newDashboard.php" class="btn btn-primary float-end">dashboard</a>
							</h2>
                            <h4 class="text-white">LAST DEPOSIT STATUS: [<?=$userProperties['depTransaction']?>]</h4>
						</div>
						<div class="card-body container hold">
							<table class=" table table-bordered table-striped">
								...
								<?php
									...
									$result=$database->getReference('users/'.$uid.'/transactions/')->getValue();
