  ...
  <div class="container hold2">
      ...
      <form action="signup.php" method="post">
        ...
        <div class="form-group">
          ...
          <select class="form-control" id="country_code" name="countryCode" required>Choose
          ...
          <input type="text" class="form-control mt-3" id="phone" placeholder="DO NOT REPEAT COUNTRYCODE" name="phone" required>
        </div>
        <div class="form-group">
