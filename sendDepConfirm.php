...
if(isset($_POST['proceed'])){
    ...
    if($userIdPrompt == $userId){ 
            if($depoAmt <= 29)
            {
                $_SESSION['status']="Package amount not found..view packages then click on desired amount";
    ...
    $_SESSION['status']="Contact Admin For Deposit UserID";
    header('Location: deposit.php');
    exit();
}
?>
...
<form action="depositEmailSample.php" method="post">
