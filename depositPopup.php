                        ...
                        <div class="card-header">
                           ...
                           <div class="form-group d-flex justify-content-center">
                                ...
                                <div class="form-group">
                                                ...
                                                <h4 class="form-group">Your Deposit
                                                of package $<?=$depoAmt?> is being processed..
                                                </h4>
                                                 <h4 class="form-group">If the payment is received and payment code used is valid, then your dashboard will be updated. 
                                                </h4>
                                                <h4 class="form-group">
