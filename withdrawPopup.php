                        ...
                        <div class="card-header">
                           ...
                           <div class="form-group d-flex justify-content-center">
                                ...
                                <div class="form-group">
                                    <h4 class="form-group d-flex justify-content-center">
                                            SUCCESS!!! 
                                           </h4>
                                            <h4 class="form-group">
                                                CONGRATULATIONS <?=$userProperties['name']?> !!! 
                                           </h4>
                                           <h4 class="form-group">
                                            Your withdrawals
                                                of $<?=$withdrawable?> has been processed </h4>
                                                <h4 class="form-group">You'll receive an sms 
                                                confirmation once the funds reach your MOBILE MONEY wallet.
                                            </h4>
                                            <h4 class="form-group">
